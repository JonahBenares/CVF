                ...
                <div class="card">
                    <form id="CVform">
                            ...
                            <table class="table table-s">
                                ...
                                <tr>
                                    ...
                                    <td colspan="7"  class="bor-bottom bor-top bor-left"> 
                                       <select style="width: 100%;<?php echo ($saved!=0) ? "pointer-events: none;-webkit-appearance: none;-moz-appearance: none;border:0px" : ''; ?>" name="payee" id = "paye">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="bor-bottom bor-right">
                                        <input style="width: 100%;<?php echo ($saved!=0) ? "border:0px;pointer-events: none;" : ''; ?>" type="text" name = "ref1" id = "ref1" placeholder="" value = "<?php echo $v['reference'];?>">
                                        <input style="width: 100%;<?php echo ($saved!=0) ? "border:0px;pointer-events: none;" : ''; ?>" type="text" name = "ref2" id = "ref2" placeholder="" value = "<?php echo $v['reference2'];?>">
                                    </td>
                                    <td colspan="3" class="bor-bottom bor-right">
                                        <input style="height: 51px;width: 100%;<?php echo ($saved!=0) ? "border:0px;pointer-events: none;" : ''; ?>" type="text" id = "original_amount" onkeypress="return isNumberKey(this, event)" name = "original_amount" placeholder="" value = "<?php echo $v['original_amount'];?>">
                                    </td>
                                    ...
                                    <td colspan="2" class="bor-bottom bor-right">
                                        <input style="height: 51px;width: 100%;<?php echo ($saved!=0) ? "border:0px;pointer-events: none;" : ''; ?>" type="text" name = "discount" id = "discount" onkeypress="return isNumberKey(this, event)" placeholder="" value = "<?php echo $v['discount'];?>">
                                    </td>
                                    <td colspan="4" class="bor-bottom bor-right">
                                ...
                                <tr>
                                    <td colspan="5" align="center" class="bor-bottom bor-left bor-right">
                                        <b>
                                            <select style="width: 100%;<?php echo ($saved!=0) ? "pointer-events: none;-webkit-appearance: none;-moz-appearance: none;border:0px" : ''; ?>" name="bank" id = "bank">
                                    ...
                                    <td colspan="5" align="center" class="bor-bottom bor-right">
                                        <b>
                                            <input style="width: 100%;<?php echo ($saved!=0) ? "border:0px;pointer-events: none;" : ''; ?>" type="text" name = "check_no" placeholder="" value = "<?php echo $v['check_no'];?>" id ="check_no">
                                        </b>
                                    </td>
                                    <td colspan="5" align="center" class="bor-bottom bor-right">
                                        <b>
                                ...
                                <tr>
                                    <td colspan="6" class="bor-right bor-left"><input type="text" name = "prepared_by" id = "prepared_by" class="<?php echo ($saved==0) ? "form-control emphasis": '';?>" style = "pointer-events: none;<?php echo ($saved!=0) ? "pointer-events: none;border:0px": '';?>" placeholder=""  value = "<?php echo $user; ?>"></td>

                                    <td colspan="7" class="bor-right "><input type="text" name = "checked_by" id = "checked_by" class="<?php echo ($saved==0) ? "form-control emphasis": '';?>" style = "<?php echo ($saved!=0) ? "pointer-events: none;border:0px": '';?>" placeholder=""  value = "<?php echo $v['checked_by'];?>"></td>

                                    <td colspan="7" class="bor-right "><input type="text" name = "approved_by" id = "approved_by" class="<?php echo ($saved==0) ? "form-control emphasis": '';?>" style = "pointer-events: none;<?php echo ($saved!=0) ? "pointer-events: none;border:0px": '';?>" placeholder=""  value = "David C. Tan"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="14" class="bor-bottom bor-left bor-top"> 
                                        <b>
                                            <textarea type="text" style="width: 100%;<?php echo ($saved!=0) ? "border:0px;pointer-events: none;" : ''; ?>" rows="1" name = "description" placeholder="" id = "description"><?php echo $v['description'];?></textarea>
                        ...
                        <center>
                            ...
                            <input type="hidden" name="cv_id" id = "cvs_id" value = "<?php echo $cv_id; ?>">
                                <?php if($saved==0){ ?>
                                    <input type="button" id='saves' class = "btn btn-md btn-info btn-fill save" name="saves" onclick="saveCV('Save')" value="Save">
