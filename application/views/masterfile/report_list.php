                        ...
                        <div class="header">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <?php if(!empty($filt)){ ?>
                                    <a href = "<?php echo base_url(); ?>index.php/masterfile/export_cv/<?php echo $payee;?>/<?php echo $t_from;?>/<?php echo $t_to;?>/<?php echo $cv_from;?>/<?php echo $cv_to;?>/<?php echo $cv_no_from;?>/<?php echo $cv_no_to;?>/<?php echo $bank;?>/<?php echo $cancelled;?>" class="btn btn-success btn-fill btn-sm"><span class="ti-export"></span> Export to Excel</a>
                                    <?php } else { ?>
